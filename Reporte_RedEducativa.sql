...
SELECT
    ...
    END AS"Estado2",
    "inscripcion"."progress_measure"                                                    AS"Progreso",
    ...
    CASE
        WHEN"inscripcion"."progress_measure"=100 THEN
    ...
    CASE WHEN"inscripcion"."progress_measure"=100 THEN 100 ELSE 0 END                   AS"Completado", 
